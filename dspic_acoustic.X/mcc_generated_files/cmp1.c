...
{           
	...
	DAC1CONL = 0x218; //CMPPOL Non Inverted; HYSPOL Rising Edge; HYSSEL None; DACEN disabled; FLTREN disabled; CBE disabled; IRQM Interrupts are disabled; INSEL CMP1D; DACOEN enabled; 
